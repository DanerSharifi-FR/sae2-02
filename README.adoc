...
| 1    | link:src/main/java/iut/sae/algo/simplicite.java[Meilleur java]| Java     | Simplicité
| 2    | link:src/main/java/iut/sae/algo/efficacite.java[Meilleur java]| Java     | Efficacité
| 3    | link:c/sobriete.c[Meilleur C]    | C     | Sobriété
...
- Java 17-21
- Un compilateur C compatible avec les standards récents (par exemple : GCC)
...
** Assurez-vous d'avoir configuré votre environnement avec JDK 17 à 21.
Compilez les fichiers Java à l'aide de la commande javac pour générer les fichiers .class.
** Exécutez les classes principales ou les tests à l'aide de la commande java.

- C :

** Compilez le fichier C à l'aide du compilateur (par exemple : GCC) avec la commande gcc -o sobriete sobriete.c.
** Exécutez le programme C généré en utilisant ./sobriete.


=== Références

- link:https://docs.oracle.com/en/java/[Documentation Java]
- link:https://gcc.gnu.org/[GCC - GNU Compiler Collection]
