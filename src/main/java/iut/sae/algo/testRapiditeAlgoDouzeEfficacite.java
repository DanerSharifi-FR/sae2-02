...
public class testRapiditeAlgoDouzeEfficacite {

    private static final String CORRECT = "abc";

    public static void main(String[] args) {
        testWithThirtyIterations();
    }

    private static void testWithTenIterations() {
        unRLE_Recursif(RLE_Recursif(CORRECT, 10), 10);
    }

    private static void testWithTwentyIterations() {
        unRLE_Recursif(RLE_Recursif(CORRECT, 20), 20);
    }

    private static void testWithThirtyIterations() {
        unRLE_Recursif(RLE_Recursif(CORRECT, 30), 30);
    }

    private static void testWithFourtyIterations() {
        unRLE_Recursif(RLE_Recursif(CORRECT, 40), 40);
    }

    private static void testWithFiftyIterations() {
        unRLE_Recursif(RLE_Recursif(CORRECT, 50), 50);
    }
